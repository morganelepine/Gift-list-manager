export default function Footer() {
    return (
        <footer className="w-full px-20 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between bg-gradient-to-r from-indigo-50 to-pink-50 shadow-md text-gray-500 text-sm">
